...
CREATE TABLE IF NOT EXISTS possiveis_ganhadores (
  ...
  tipo_sorteio VARCHAR(20) NOT NULL,
  ...
  KEY idx_usuario (usuario_id),
  KEY idx_numero (numero),
  KEY idx_tipo_periodo (tipo_sorteio, periodo_referencia, periodo_ano),
...
CREATE TABLE IF NOT EXISTS ganhadores (
  ...
  status ENUM('contemplado', 'desclassificado') NOT NULL DEFAULT 'contemplado',
